...
export default class App extends Component {
  ...
  componentWillUpdate() {
    ...
    if (parseInt(this.state.counter1) + parseInt(this.state.counter2) == this.state.sum) {
      this.setState(() => ({ sum: parseInt(this.state.counter1) + parseInt(this.state.counter2) + parseInt(this.state.counter3) }))
    }
  }
  render() {
    return (
      ...
      <div className="App">
        ...
        <CounterClicker counterValue={this.state.counter3} onIncrement={_ => this.counter_3_Increment(1)} />
